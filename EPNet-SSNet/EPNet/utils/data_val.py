...
class PolypObjDataset(data.Dataset):
    def __init__(self, image_root, gt_root, trainsize):
        ...
        # # 检查 image_root 路径是否存在
        # if not os.path.exists(image_root):
        #     print(f"Directory does not exist: {image_root}")
        #     # 这里可以选择抛出异常或者直接返回，防止后续代码执行
        #     raise FileNotFoundError(f"Directory does not exist: {image_root}")
        #
        # # 检查 gt_root 路径是否存在
        # if not os.path.exists(gt_root):
        #     print(f"Directory does not exist: {gt_root}")
        #     # 这里可以选择抛出异常或者直接返回，防止后续代码执行
        #     raise FileNotFoundError(f"Directory does not exist: {gt_root}")
