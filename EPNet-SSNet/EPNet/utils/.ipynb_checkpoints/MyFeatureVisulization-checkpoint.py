...
for _data_name in ['CAMO']:#原vis,通过循环设置为'CAMO' 'CHAMELEON', 'COD10K'
    data_path = '/home/stuart/pythonProjectWsl/SINet-V2/SINet-V2-main/Dataset/TestDataset/{}/'.format(_data_name)
